...
const Layout = () => {
  ...
  return (
    <>
      <Grid className="border" container spacing={3}  sx={{
              position: "sticky",
              top: 40,
          
              backgroundColor: "white", // Keeps the background visible
             
           
              boxShadow: "0px 2px 5px rgba(0, 0, 0, 0.1)", // Adds slight shadow effect
            }}>
        <Grid item xs={12}>
          <Toolbar
          ...
          >
            <div style={{ flexGrow: 1, display: "flex", gap: "20px" }}>
              ...
              >
                <Link className="text-decoration-none text-black" to="/classwork">
                  Classwork
                </Link>
              </Button>
              <Link to="/People">
