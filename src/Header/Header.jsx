...
import iconimg from "../images/profile.png";
            ...
            {[
              ...
              <ListItem key={text} disablePadding sx={{ display: "block" }}>
                ...
                {text === "Enrolled" && showEnrolledOptions && (
                  <Box sx={{ mt: 1, mr: "5" }}>
                    {[
                      { name: 'English 02', path: '/english_02' },
                      { name: 'Web Development SO2', description: 'Cohort 2 - Kingri', path: '/web_Development_SO2' },
                      { name: 'Professional Development',escription: 'Cohort 02 - Kingri', path: '/professional_Development' },
                      { name: 'English Communication', description: 'Kingri C2', path: '/english_Communication' },
                      { name: 'Web Dev Frontend S01', description: 'Cohort 2 - Kingri', path: '/web_Dev_Frontend_S01' },
                    ].map((option, i) => (
                      <ListItem
                        key={i}
                        disablePadding
